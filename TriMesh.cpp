...
TriMesh::TriMesh(std::shared_ptr<Geometry> &geometry, std::shared_ptr<ShaderMaterial> &material) {
    m_geometry = geometry;
    m_material = material;
    m_cullFace = [](){
...
std::shared_ptr<TriMesh> TriMesh::create(std::shared_ptr<Geometry> &geometry,
                                         std::shared_ptr<ShaderMaterial> &material) {
    return std::shared_ptr<TriMesh>(new TriMesh(geometry, material));
}
