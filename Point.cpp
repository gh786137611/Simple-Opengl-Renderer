...
std::shared_ptr<Point> Point::create(std::shared_ptr<SGL::Geometry> geometry, std::shared_ptr<SGL::ShaderMaterial> material) {
    return  std::shared_ptr<Point>(new Point(geometry, material));
}
